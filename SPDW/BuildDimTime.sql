CREATE OR ALTER PROCEDURE ddw2DW.BuildDimTime
    @MinDate DATE,
    @MaxDate DATE
AS
/***************************************************************************************************
...
Steps:          NA
Parameter(s):   None
Usage:          EXEC ddw2DW.BuildDimTime @MinDate = '1/1/2020',
                                        @MaxDate = '1/31/2022';
****************************************************************************************************
SUMMARY OF CHANGES
...
-------------------------------------------------------------------------------
SET @ErrorText = 'Failed Build Table ddw2DW.DimTime.';

-- Delete contents of Date Dimension Table
TRUNCATE TABLE ddw2DW.DimTime;
...
SET @Message = 'Completed Build Table ddw2DW.DimTime.';
